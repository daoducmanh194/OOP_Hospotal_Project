...
public class ReturnAllPatientPhone {
	...
	public ObservableList<Patient> allPatientPhone(String phone) {
		try {
			...
			int sPhone = Integer.parseInt(phone);
			statement.setInt(1, sPhone);
